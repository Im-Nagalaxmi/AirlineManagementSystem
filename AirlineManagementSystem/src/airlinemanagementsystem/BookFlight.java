...
public class BookFlight extends JFrame implements ActionListener {
    ...
    JDateChooser dcdate;
     ...
     public BookFlight() {
        ...
        lblfname.setFont(new Font("Serif", Font.PLAIN, 16));
        add(lblfname);
        ...
        lblfcode.setFont(new Font("Serif", Font.PLAIN, 16));
        add(lblfcode);
        ...
        lbldate.setFont(new Font("Serif", Font.PLAIN, 16));
        add(lbldate);
        ...
        ImageIcon image = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/details.png"));
